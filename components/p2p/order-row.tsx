...
import { BadgeCheck, Check, Clock, Copy, Star } from "lucide-react";
...
export function OrderRow({ order }: { order: P2POrder }) {
  ...
  return (
    <div
      data-slot="order-row"
      className={cn(
        "grid gap-5 px-5 py-5 transition-colors hover:bg-muted/40 lg:items-center lg:gap-6 lg:px-6",
        ORDER_GRID,
      )}
    >
